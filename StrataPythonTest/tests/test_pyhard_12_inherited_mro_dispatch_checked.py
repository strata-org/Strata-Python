...
_pyhard_runtime_shapes = {'Base': {'kind': 'class', 'fields': {}}, 'Leaf': {'kind': 'class', 'fields': {}}, 'Middle': {'kind': 'class', 'fields': {}}}
...
class Base:
    ...
    def inherited(self) -> str:
        _pyhard_runtime_assert_state(locals(), [{'name': 'self', 'status': 'definitely_bound', 'tags': ['Base']}], 'Base.inherited:L3')
        _pyhard_runtime_assume_state(locals(), [{'name': 'self', 'status': 'definitely_bound', 'tags': ['Base']}], 'Base.inherited:L3')
        return _pyhard_runtime_checked_value('base', {'args': [], 'display': 'str', 'kind': 'atomic', 'literals': [], 'name': 'str', 'outer_tags': ['str'], 'variadic': False}, 'Base.inherited:return:L3:result')
...
class Leaf(Middle):
    ...
    def local(self) -> int:
        _pyhard_runtime_assert_state(locals(), [{'name': 'self', 'status': 'definitely_bound', 'tags': ['Leaf']}], 'Leaf.local:L12')
        _pyhard_runtime_assume_state(locals(), [{'name': 'self', 'status': 'definitely_bound', 'tags': ['Leaf']}], 'Leaf.local:L12')
        return _pyhard_runtime_checked_value(3, {'args': [], 'display': 'int', 'kind': 'atomic', 'literals': [], 'name': 'int', 'outer_tags': ['int'], 'variadic': False}, 'Leaf.local:return:L12:result')

def use_leaf(value: Leaf) -> tuple[str, int]:
    _pyhard_runtime_assert_value(value, {'args': [], 'display': 'Leaf', 'kind': 'atomic', 'literals': [], 'name': 'Leaf', 'outer_tags': ['Leaf'], 'variadic': False}, 'use_leaf:parameter:L15:value')
    _pyhard_runtime_assume_value(value, {'args': [], 'display': 'Leaf', 'kind': 'atomic', 'literals': [], 'name': 'Leaf', 'outer_tags': ['Leaf'], 'variadic': False}, 'use_leaf:parameter:L15:value')
    _pyhard_runtime_assert_state(locals(), [{'name': 'value', 'status': 'definitely_bound', 'tags': ['Leaf']}], 'use_leaf:L16')
    _pyhard_runtime_assume_state(locals(), [{'name': 'value', 'status': 'definitely_bound', 'tags': ['Leaf']}], 'use_leaf:L16')
    return _pyhard_runtime_checked_value((value.inherited(), value.local()), {'args': [{'args': [], 'display': 'str', 'kind': 'atomic', 'literals': [], 'name': 'str', 'outer_tags': ['str'], 'variadic': False}, {'args': [], 'display': 'int', 'kind': 'atomic', 'literals': [], 'name': 'int', 'outer_tags': ['int'], 'variadic': False}], 'display': 'tuple[str, int]', 'kind': 'generic', 'literals': [], 'name': 'tuple', 'outer_tags': ['tuple'], 'variadic': False}, 'use_leaf:return:L16:result')
