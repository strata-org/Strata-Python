...
def combine(left: int, right: int, scale: float, prefix: str, suffix: str) -> tuple[int, float, str]:
    _pyhard_runtime_assert_value(left, {'args': [], 'display': 'int', 'kind': 'atomic', 'literals': [], 'name': 'int', 'outer_tags': ['int'], 'variadic': False}, 'combine:parameter:L2:left')
    _pyhard_runtime_assume_value(left, {'args': [], 'display': 'int', 'kind': 'atomic', 'literals': [], 'name': 'int', 'outer_tags': ['int'], 'variadic': False}, 'combine:parameter:L2:left')
    _pyhard_runtime_assert_value(right, {'args': [], 'display': 'int', 'kind': 'atomic', 'literals': [], 'name': 'int', 'outer_tags': ['int'], 'variadic': False}, 'combine:parameter:L3:right')
    _pyhard_runtime_assume_value(right, {'args': [], 'display': 'int', 'kind': 'atomic', 'literals': [], 'name': 'int', 'outer_tags': ['int'], 'variadic': False}, 'combine:parameter:L3:right')
    _pyhard_runtime_assert_value(scale, {'args': [], 'display': 'float', 'kind': 'atomic', 'literals': [], 'name': 'float', 'outer_tags': ['float'], 'variadic': False}, 'combine:parameter:L4:scale')
    _pyhard_runtime_assume_value(scale, {'args': [], 'display': 'float', 'kind': 'atomic', 'literals': [], 'name': 'float', 'outer_tags': ['float'], 'variadic': False}, 'combine:parameter:L4:scale')
    _pyhard_runtime_assert_value(prefix, {'args': [], 'display': 'str', 'kind': 'atomic', 'literals': [], 'name': 'str', 'outer_tags': ['str'], 'variadic': False}, 'combine:parameter:L5:prefix')
    _pyhard_runtime_assume_value(prefix, {'args': [], 'display': 'str', 'kind': 'atomic', 'literals': [], 'name': 'str', 'outer_tags': ['str'], 'variadic': False}, 'combine:parameter:L5:prefix')
    _pyhard_runtime_assert_value(suffix, {'args': [], 'display': 'str', 'kind': 'atomic', 'literals': [], 'name': 'str', 'outer_tags': ['str'], 'variadic': False}, 'combine:parameter:L6:suffix')
    _pyhard_runtime_assume_value(suffix, {'args': [], 'display': 'str', 'kind': 'atomic', 'literals': [], 'name': 'str', 'outer_tags': ['str'], 'variadic': False}, 'combine:parameter:L6:suffix')
    _pyhard_runtime_assert_state(locals(), [{'name': 'left', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'mixed', 'status': 'definitely_unbound', 'tags': []}, {'name': 'prefix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'right', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'scale', 'status': 'definitely_bound', 'tags': ['bool', 'float', 'int']}, {'name': 'suffix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'text', 'status': 'definitely_unbound', 'tags': []}, {'name': 'whole', 'status': 'definitely_unbound', 'tags': []}], 'combine:L8')
    _pyhard_runtime_assume_state(locals(), [{'name': 'left', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'mixed', 'status': 'definitely_unbound', 'tags': []}, {'name': 'prefix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'right', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'scale', 'status': 'definitely_bound', 'tags': ['bool', 'float', 'int']}, {'name': 'suffix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'text', 'status': 'definitely_unbound', 'tags': []}, {'name': 'whole', 'status': 'definitely_unbound', 'tags': []}], 'combine:L8')
    whole = left + right
    _pyhard_runtime_assert_state(locals(), [{'name': 'left', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'mixed', 'status': 'definitely_unbound', 'tags': []}, {'name': 'prefix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'right', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'scale', 'status': 'definitely_bound', 'tags': ['bool', 'float', 'int']}, {'name': 'suffix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'text', 'status': 'definitely_unbound', 'tags': []}, {'name': 'whole', 'status': 'definitely_bound', 'tags': ['int']}], 'combine:L9')
    _pyhard_runtime_assume_state(locals(), [{'name': 'left', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'mixed', 'status': 'definitely_unbound', 'tags': []}, {'name': 'prefix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'right', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'scale', 'status': 'definitely_bound', 'tags': ['bool', 'float', 'int']}, {'name': 'suffix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'text', 'status': 'definitely_unbound', 'tags': []}, {'name': 'whole', 'status': 'definitely_bound', 'tags': ['int']}], 'combine:L9')
    mixed = whole * scale
    _pyhard_runtime_assert_state(locals(), [{'name': 'left', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'mixed', 'status': 'definitely_bound', 'tags': ['float', 'int']}, {'name': 'prefix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'right', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'scale', 'status': 'definitely_bound', 'tags': ['bool', 'float', 'int']}, {'name': 'suffix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'text', 'status': 'definitely_unbound', 'tags': []}, {'name': 'whole', 'status': 'definitely_bound', 'tags': ['int']}], 'combine:L10')
    _pyhard_runtime_assume_state(locals(), [{'name': 'left', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'mixed', 'status': 'definitely_bound', 'tags': ['float', 'int']}, {'name': 'prefix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'right', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'scale', 'status': 'definitely_bound', 'tags': ['bool', 'float', 'int']}, {'name': 'suffix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'text', 'status': 'definitely_unbound', 'tags': []}, {'name': 'whole', 'status': 'definitely_bound', 'tags': ['int']}], 'combine:L10')
    text = prefix + suffix
    _pyhard_runtime_assert_state(locals(), [{'name': 'left', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'mixed', 'status': 'definitely_bound', 'tags': ['float', 'int']}, {'name': 'prefix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'right', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'scale', 'status': 'definitely_bound', 'tags': ['bool', 'float', 'int']}, {'name': 'suffix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'text', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'whole', 'status': 'definitely_bound', 'tags': ['int']}], 'combine:L11')
    _pyhard_runtime_assume_state(locals(), [{'name': 'left', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'mixed', 'status': 'definitely_bound', 'tags': ['float', 'int']}, {'name': 'prefix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'right', 'status': 'definitely_bound', 'tags': ['bool', 'int']}, {'name': 'scale', 'status': 'definitely_bound', 'tags': ['bool', 'float', 'int']}, {'name': 'suffix', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'text', 'status': 'definitely_bound', 'tags': ['str']}, {'name': 'whole', 'status': 'definitely_bound', 'tags': ['int']}], 'combine:L11')
    return _pyhard_runtime_checked_value((whole, mixed, text), {'args': [{'args': [], 'display': 'int', 'kind': 'atomic', 'literals': [], 'name': 'int', 'outer_tags': ['int'], 'variadic': False}, {'args': [], 'display': 'float', 'kind': 'atomic', 'literals': [], 'name': 'float', 'outer_tags': ['float'], 'variadic': False}, {'args': [], 'display': 'str', 'kind': 'atomic', 'literals': [], 'name': 'str', 'outer_tags': ['str'], 'variadic': False}], 'display': 'tuple[int, float, str]', 'kind': 'generic', 'literals': [], 'name': 'tuple', 'outer_tags': ['tuple'], 'variadic': False}, 'combine:return:L11:result')
