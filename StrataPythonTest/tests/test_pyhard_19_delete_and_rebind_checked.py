...
def delete_then_rebind() -> int:
    _pyhard_runtime_assert_state(locals(), [{'name': 'value', 'status': 'definitely_unbound', 'tags': []}], 'delete_then_rebind:L2')
    _pyhard_runtime_assume_state(locals(), [{'name': 'value', 'status': 'definitely_unbound', 'tags': []}], 'delete_then_rebind:L2')
    value = 1
    _pyhard_runtime_assert_state(locals(), [{'name': 'value', 'status': 'definitely_bound', 'tags': ['int']}], 'delete_then_rebind:L3')
    _pyhard_runtime_assume_state(locals(), [{'name': 'value', 'status': 'definitely_bound', 'tags': ['int']}], 'delete_then_rebind:L3')
    del value
    _pyhard_runtime_assert_state(locals(), [{'name': 'value', 'status': 'definitely_unbound', 'tags': []}], 'delete_then_rebind:L4')
    _pyhard_runtime_assume_state(locals(), [{'name': 'value', 'status': 'definitely_unbound', 'tags': []}], 'delete_then_rebind:L4')
    value = 2
    _pyhard_runtime_assert_state(locals(), [{'name': 'value', 'status': 'definitely_bound', 'tags': ['int']}], 'delete_then_rebind:L5')
    _pyhard_runtime_assume_state(locals(), [{'name': 'value', 'status': 'definitely_bound', 'tags': ['int']}], 'delete_then_rebind:L5')
    return _pyhard_runtime_checked_value(value, {'args': [], 'display': 'int', 'kind': 'atomic', 'literals': [], 'name': 'int', 'outer_tags': ['int'], 'variadic': False}, 'delete_then_rebind:return:L5:result')

def delete_then_read() -> int:
    _pyhard_runtime_assert_state(locals(), [{'name': 'value', 'status': 'definitely_unbound', 'tags': []}], 'delete_then_read:L9')
    _pyhard_runtime_assume_state(locals(), [{'name': 'value', 'status': 'definitely_unbound', 'tags': []}], 'delete_then_read:L9')
    value = 1
    _pyhard_runtime_assert_state(locals(), [{'name': 'value', 'status': 'definitely_bound', 'tags': ['int']}], 'delete_then_read:L10')
    _pyhard_runtime_assume_state(locals(), [{'name': 'value', 'status': 'definitely_bound', 'tags': ['int']}], 'delete_then_read:L10')
    del value
    _pyhard_runtime_assert_state(locals(), [{'name': 'value', 'status': 'definitely_unbound', 'tags': []}], 'delete_then_read:L11')
    _pyhard_runtime_assume_state(locals(), [{'name': 'value', 'status': 'definitely_unbound', 'tags': []}], 'delete_then_read:L11')
    return _pyhard_runtime_checked_value(value, {'args': [], 'display': 'int', 'kind': 'atomic', 'literals': [], 'name': 'int', 'outer_tags': ['int'], 'variadic': False}, 'delete_then_read:return:L11:result')
