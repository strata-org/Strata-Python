...
<mode> is one of match / fullmatch / search. This mirrors the output contract
of the Strata-side DiffTestCore tool so the Lean test can classify the two
result streams symmetrically. The corpus is guaranteed tab- and newline-free
