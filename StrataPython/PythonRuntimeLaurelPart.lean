...
procedure re_Match_group (self : re_Match, n : int) : string;
procedure re_Match_start (self : re_Match, n : int) : int;
procedure re_Match_end   (self : re_Match, n : int) : int;
procedure re_Match_span_start (self : re_Match, n : int) : int;
procedure re_Match_span_end   (self : re_Match, n : int) : int;
procedure re_Match_lastindex  (self : re_Match) : int;
procedure re_Match_lastgroup  (self : re_Match) : string;
procedure re_Match_groups     (self : re_Match) : ListStr;

procedure re_pattern_error(pattern : string) : Error
  external;
...
procedure re_fullmatch_bool(pattern : string, s : string) : bool
  external;
procedure re_match_bool(pattern : string, s : string) : bool
  external;
procedure re_search_bool(pattern : string, s : string) : bool
  external;
...
procedure mk_re_Match(s : string) : Any
  return from_ClassInstance("re_Match",
...
procedure re_compile(pattern : Any) : Any
  requires Any..isfrom_str(pattern)
  return pattern;

procedure re_fullmatch(pattern : Any, s : Any) : Any
  requires Any..isfrom_str(pattern) && Any..isfrom_str(s)
  return if Error..isRePatternError(re_pattern_error(Any..as_string!(pattern)))
...
procedure re_match(pattern : Any, s : Any) : Any
  requires Any..isfrom_str(pattern) && Any..isfrom_str(s)
  return if Error..isRePatternError(re_pattern_error(Any..as_string!(pattern)))
    then exception(re_pattern_error(Any..as_string!(pattern)))
...
procedure re_search(pattern : Any, s : Any) : Any
  requires Any..isfrom_str(pattern) && Any..isfrom_str(s)
  return if Error..isRePatternError(re_pattern_error(Any..as_string!(pattern)))
    then exception(re_pattern_error(Any..as_string!(pattern)))
...
procedure isBool (v: Any) : Any
  return from_bool (Any..isfrom_bool(v));

procedure isInt (v: Any) : Any
  return from_bool (Any..isfrom_int(v));

procedure isFloat (v: Any) : Any
  return from_bool (Any..isfrom_float(v));

procedure isString (v: Any) : Any
  return from_bool (Any..isfrom_str(v));

procedure isdatetime (v: Any) : Any
  return from_bool (Any..isfrom_datetime(v));

procedure isDict (v: Any) : Any
  return from_bool (Any..isfrom_DictStrAny(v));

procedure isList (v: Any) : Any
  return from_bool (Any..isfrom_ListAny(v));

procedure isClassInstance (v: Any) : Any
  return from_bool (Any..isfrom_ClassInstance(v));

procedure isInstance_of_Int (v: Any) : Any
  return from_bool (Any..isfrom_int(v) || Any..isfrom_bool(v));

procedure isInstance_of_Float (v: Any) : Any
  return from_bool (Any..isfrom_float(v) || Any..isfrom_int(v) || Any..isfrom_bool(v));
...
procedure isTypeError (e: Error) : Any
return from_bool (Error..isTypeError(e));

procedure isAttributeError (e: Error) : Any
return from_bool (Error..isAttributeError(e));

procedure isAssertionError (e: Error) : Any
return from_bool (Error..isAssertionError(e));

procedure isUnimplementedError (e: Error) : Any
return from_bool (Error..isUnimplementedError(e));

procedure isUndefinedError (e: Error) : Any
return from_bool (Error..isUndefinedError(e));

procedure isError (e: Error) : bool
return ! Error..isNoError(e);
...
procedure Any_to_bool (v: Any) : bool
return if (Any..isfrom_bool(v)) then Any..as_bool!(v) else
...
procedure to_bool_any(v: Any) : Any
return from_bool(Any_to_bool(v));

// /////////////////////////////////////////////////////////////////////////////////////
// ListAny functions
// /////////////////////////////////////////////////////////////////////////////////////

procedure List_len (l : ListAny) : int
return if ListAny..isListAny_nil(l) then 0 else 1 + List_len(ListAny..tail!(l));
...
procedure List_contains (l : ListAny, x: Any) : bool
return if ListAny..isListAny_nil(l) then false else (ListAny..head!(l) == x) || List_contains(ListAny..tail!(l), x);

procedure List_extend (l1 : ListAny, l2: ListAny) : ListAny
return if ListAny..isListAny_nil(l1) then l2
  else ListAny_cons(ListAny..head!(l1), List_extend(ListAny..tail!(l1), l2));

procedure List_get_non_neg (l : ListAny, i : int) : Any
  requires i >= 0 && i < List_len(l)
return if ListAny..isListAny_nil(l) then from_None()
  else if  i == 0 then ListAny..head!(l)
  else List_get_non_neg(ListAny..tail!(l), i - 1);

procedure List_get (l : ListAny, i : int) : Any
  requires i >= - List_len(l) && i < List_len(l)
return if i >= 0 then List_get_non_neg(l, i)
  else List_get_non_neg(l, List_len(l) + i);

procedure List_take (l : ListAny, i: int) : ListAny
  requires i >= 0 && i <= List_len(l)
...
procedure List_drop (l : ListAny, i: int) : ListAny
  requires i >= 0 && i <= List_len(l)
return if ListAny..isListAny_nil(l) then ListAny_nil()
  else if  i == 0 then l
...
procedure int_max (i1: int, i2: int) : int
return if i1 >= i2 then i1 else i2;

procedure int_min (i1: int, i2: int) : int
return if i1 <= i2 then i1 else i2;

procedure List_slice_non_neg (l : ListAny, start : int, stop: int) : ListAny
  requires start >= 0 && stop >= 0
return if (start >= List_len(l)) || (start >= stop) then ListAny_nil()
  else List_take (List_drop (l, start), int_min(stop, List_len(l))  - start);


procedure List_slice (l : ListAny, start : int, stop: int) : ListAny
return List_slice_non_neg (l,
...
procedure List_set (l : ListAny, i : int, v: Any) : ListAny
  requires i >= - List_len(l) && i < List_len(l)
return if i >= 0 then List_set_non_neg(l, i, v)
  else List_set_non_neg(l, List_len(l) + i, v);

//Require recursive function on int
procedure List_repeat (l: ListAny, n: int): ListAny;

procedure range (start: Any, stop: Any, step: Any) : Any
...
procedure DictStrAny_contains (d : DictStrAny, key: string) : bool
return if DictStrAny..isDictStrAny_empty(d) then false
  else (DictStrAny..key!(d) == key) || DictStrAny_contains(DictStrAny..tail!(d), key);

procedure DictStrAny_get (d : DictStrAny, key: string) : Any
  requires DictStrAny_contains(d, key)
return if  DictStrAny..isDictStrAny_empty(d) then from_None()
  else if DictStrAny..key!(d) == key then DictStrAny..val!(d)
  else DictStrAny_get(DictStrAny..tail!(d), key);

procedure DictStrAny_get_or_none (d : DictStrAny, key: string) : Any
return if DictStrAny_contains(d, key) then DictStrAny_get(d, key)
  else from_None();

procedure Any_get_or_none (dict: Any, key: Any) : Any
  requires Any..isfrom_DictStrAny(dict) && Any..isfrom_str(key)
return DictStrAny_get_or_none(Any..as_Dict!(dict), Any..as_string!(key));

procedure DictStrAny_insert (d : DictStrAny, key: string, val: Any) : DictStrAny
return if DictStrAny..isDictStrAny_empty(d) then DictStrAny_cons(key, val, DictStrAny_empty())
...
return if Any..isfrom_DictStrAny(dictOrList) then
...
procedure Any_get! (dictOrList: Any, index: Any): Any
return if Any..isexception(dictOrList) then dictOrList
...
procedure Any_set (dictOrList: Any, index: Any, val: Any): Any
...
return if ListAny..isListAny_nil(indices) then dictOrList
...
procedure Any_iter_index(iter: Any, index: int) : Any;

procedure PIn (v: Any, dictOrList: Any) : Any
...
procedure PNotIn ( v: Any, dictOrList: Any) : Any
  requires (Any..isfrom_DictStrAny(dictOrList) && Any..isfrom_str(v)) || Any..isfrom_ListAny(dictOrList)
return from_bool(
    if Any..isfrom_DictStrAny(dictOrList) then
      !DictStrAny_contains(Any..as_Dict!(dictOrList), Any..as_string!(v))
...
procedure is_IntReal (v: Any) : bool;
procedure Any_real_to_int (v: Any) : int;

procedure normalize_any (v : Any) : Any
return if v == from_bool(true) then from_int(1)
...
procedure Str.Concat(s: string, s2: string): string external;

procedure PAdd (v1: Any, v2: Any) : Any
...
procedure PSub (v1: Any, v2: Any) : Any
return if Any..isexception(v1) then v1 else if Any..isexception(v2) then v2
  else if Any..isfrom_bool(v1) && Any..isfrom_bool(v2) then
    from_int(bool_to_int(Any..as_bool!(v1)) - bool_to_int(Any..as_bool!(v2)))
  else if Any..isfrom_bool(v1) && Any..isfrom_int(v2) then
...
procedure string_repeat (s: string, i: int) : string;

procedure PMul (v1: Any, v2: Any) : Any
return if Any..isexception(v1) then v1 else if Any..isexception(v2) then v2
  else if Any..isfrom_bool(v1) && Any..isfrom_bool(v2) then
    from_int(bool_to_int(Any..as_bool!(v1)) * bool_to_int(Any..as_bool!(v2)))
  else if Any..isfrom_bool(v1) && Any..isfrom_int(v2) then
...
procedure string_lt (s1: string, s2: string) : bool;
procedure string_le (s1: string, s2: string) : bool;
procedure string_gt (s1: string, s2: string) : bool;
procedure string_ge (s1: string, s2: string) : bool;
procedure List_lt (l1: ListAny, l2: ListAny): bool;
procedure List_le (l1: ListAny, l2: ListAny): bool;
procedure List_gt (l1: ListAny, l2: ListAny): bool;
procedure List_ge (l1: ListAny, l2: ListAny): bool;

procedure PLt (v1: Any, v2: Any) : Any
return if Any..isexception(v1) then v1 else if Any..isexception(v2) then v2
  else if Any..isfrom_bool(v1) && Any..isfrom_bool(v2) then
...
procedure PLe (v1: Any, v2: Any) : Any
return if Any..isexception(v1) then v1 else if Any..isexception(v2) then v2
  else if Any..isfrom_bool(v1) && Any..isfrom_bool(v2) then
    from_bool(bool_to_int(Any..as_bool!(v1)) <= bool_to_int(Any..as_bool!(v2)))
  else if Any..isfrom_bool(v1) && Any..isfrom_int(v2) then
...
procedure PGt (v1: Any, v2: Any) : Any
return if Any..isexception(v1) then v1 else if Any..isexception(v2) then v2
  else if Any..isfrom_bool(v1) && Any..isfrom_bool(v2) then
    from_bool(bool_to_int(Any..as_bool!(v1)) > bool_to_int(Any..as_bool!(v2)))
  else if Any..isfrom_bool(v1) && Any..isfrom_int(v2) then
...
procedure PGe (v1: Any, v2: Any) : Any
return if Any..isexception(v1) then v1 else if Any..isexception(v2) then v2
  else if Any..isfrom_bool(v1) && Any..isfrom_bool(v2) then
    from_bool(bool_to_int(Any..as_bool!(v1)) >= bool_to_int(Any..as_bool!(v2)))
  else if Any..isfrom_bool(v1) && Any..isfrom_int(v2) then
...
procedure PEq (v: Any, v': Any) : Any
return from_bool(normalize_any(v) == normalize_any (v'));

procedure PNEq (v: Any, v': Any) : Any
return from_bool(normalize_any(v) != normalize_any (v'));
...
procedure PAnd (v1: Any, v2: Any) : Any
return if Any..isexception(v1) then v1 else
  if ! Any_to_bool (v1) then v1 else v2;

procedure POr (v1: Any, v2: Any) : Any
return if Any..isexception(v1) then v1 else
  if Any_to_bool (v1) then v1 else v2;
...
procedure PPow (v1: Any, v2: Any) : Any
return if Any..isexception(v1) then v1 else if Any..isexception(v2) then v2
...
procedure PMod (v1: Any, v2: Any) : Any
  requires (Any..isfrom_bool(v2)==>Any..as_bool!(v2)) && (Any..isfrom_int(v2)==>Any..as_int!(v2)!=0)
return if Any..isexception(v1) then v1 else if Any..isexception(v2) then v2
  else if Any..isfrom_bool(v1) && Any..isfrom_bool(v2) then
    from_int( bool_to_int(Any..as_bool!(v1)) % bool_to_int(Any..as_bool!(v2)))
...
procedure PLShift (v1: Any, v2: Any) : Any
return if Any..isexception(v1) then v1 else if Any..isexception(v2) then v2
  else if Any..isfrom_int(v1) && Any..isfrom_int(v2) && Any..as_int!(v2) >= 0 then
...
procedure PRShift (v1: Any, v2: Any) : Any
return if Any..isexception(v1) then v1 else if Any..isexception(v2) then v2
  else if Any..isfrom_int(v1) && Any..isfrom_int(v2) && Any..as_int!(v2) >= 0 then
...
procedure to_string(a: Any) : string;

procedure to_string_any(a: Any) : Any
return from_str(to_string(a));

procedure datetime_strptime(dtstring: Any, format: Any) : Any;
